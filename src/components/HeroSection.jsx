  ...
  return (
    <div className="bg-fourth-color w-full  2xl:h-1/4  min-h-56 max-h-fit flex md:flex-row flex-col gap-0 md:gap-32 2xl:gap-56 justify-center items-center">
      <div className="flex flex-col justify-center items-start gap-6">
        <h1 className="text-3xl font-semibold md:text-6xl 2xl:text-7xl text-third-color flex flex-col gap-2">
          <span>Grab Upto 50% Off On </span>
          <span>Selected Product</span>
        </h1>
        <button className="flex w-full md:w-40 text-xl items-center justify-center font-normal bg-third-color py-3 text-main-color rounded-full">
          Buy Now
        </button>
      </div>
      <div>
