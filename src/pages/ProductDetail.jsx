...
const ProductDetail = () => {
  ...
  return (
    <div className="min-h-screen  flex flex-col max-h-fit bg-second-color 2xl:gap-10 gap-6 pt-16">
      <Link
        to="/"
      ...
      <div className="flex md:flex-row flex-col px-2 gap-4 md:gap-10">
        ...
        <div className="md:w-1/2 w-full flex flex-col md:gap-5 gap-3 2xl:gap-8 justify-evenly">
          ...
          <div className="md:hidden flex justify-starts gap-2 items-center">
          ...
          <button className="bg-third-color md:w-1/2 py-3 2xl:py-5 2xl:text-2xl rounded-full text-main-color">
            Add to Cart
          </button>
        </div>
      </div>
